...
<asp:Content ID="Content" ContentPlaceHolderID="plcContent" runat="Server">
    ...
    <cms:CMSUpdatePanel ID="upSettingsSetup" runat="server" UpdateMode="Conditional" RenderMode="Block" ShowProgress="True">
        <ContentTemplate>
            <div class="form-horizontal" style="padding-top: 20px;">
                ...
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <cms:SelectPath runat="server" ID="ctrlSelectPath" MaxLength="450" />
                    </div>
                </div>
                <asp:Label runat="server" ID="vlmSelectedItems" ForeColor="red" />
                <div class="form-group" style="padding-top: 20px;">
                    <cms:UniGrid runat="server" ID="ugImportSelection" PageSize="10000" DefaultPageSize="10000" ShowActionsMenu="False" ShowExportMenu="False">
                        <GridColumns>
