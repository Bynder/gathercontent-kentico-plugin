...
<asp:Content ID="Content" ContentPlaceHolderID="plcContent" runat="Server">
    <div class="form-horizontal">
        ...
        <div class="form-group" style="padding-top: 20px;">
            <cms:UniGrid runat="server" ID="ugResault" PageSize="10000" DefaultPageSize="10000" ShowActionsMenu="False" ShowExportMenu="False" Visible="False">
                <GridColumns>
                    <ug:Column Caption="Workflow Status" Source="Status" ExternalSourceName="status" AllowSorting="True" Wrap="False" runat="server" />
                    <ug:Column Caption="GatherContent Item Name" Source="Name" AllowSorting="True" runat="server" />
                    <ug:Column Caption="Import Status" Source="ImportMessage" AllowSorting="True" runat="server" />
                    <ug:Column Caption="GatherContent Template Name" Source="TemplateName" AllowSorting="True" runat="server" />
