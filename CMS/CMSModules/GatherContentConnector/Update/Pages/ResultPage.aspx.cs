namespace GatherContentConnector.CMSModules.GatherContentConnector.Update.Pages
{
    ...
    /// <summary>The result page.</summary>
    ...
    public partial class ResultPage : CMSAdministrationPage
    {
        ...
        private void InitResault()
        {
            ...
            this.lbCountSuccessfully.Text =
                this.lbCountSuccessfully1.Text =
                    result.Count(x => x.ImportMessage != null && x.ImportMessage.IndexOf("failed", StringComparison.InvariantCultureIgnoreCase) < 0).ToString();
            this.lbCountErrors.Text =
                this.lbCountErrors1.Text =
                    result.Count(x => x.ImportMessage != null && x.ImportMessage.IndexOf("failed", StringComparison.InvariantCultureIgnoreCase) > -1).ToString();
