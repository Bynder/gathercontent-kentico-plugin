namespace GatherContent.Connector.Managers.Managers
{
  ...
  public class MappingManager : BaseManager, IMappingManager
  {
    ...
    public List<CmsTemplateFieldModel> GetCmsTemplateFields(string cmsTemplateId)
    {
      ...
      IEnumerable<CmsTemplateFieldModel> result =
        fields.Select(
        ...
        var mappingModel = new MappingModel
                             {
                               ...
                               GcTemplate = new GcTemplateModel { Id = templateMapping.GcTemplate.GcTemplateId, Name = templateMapping.GcTemplate.GcTemplateName, },
    ...
    private MappingModel MapAddMappingModel(TemplateMapping templateMapping)
    {
      ...
      foreach (var fieldMapping in templateMapping.FieldMappings)
      {
        addCmsMappingModel.FieldMappings.Add(
          new FieldMappingModel { CmsTemplateId = fieldMapping.CmsField.TemplateField.FieldId, GcFieldId = fieldMapping.GcField.Id, GcFieldName = fieldMapping.GcField.Name });
      }
