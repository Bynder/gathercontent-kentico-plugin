                                                                     ...
                                                                     new List<MapRule>()
                                                                         {
                                                                             ...
                                                                             new MapRule()
                                                                                 {
                                                                                     ControlType = FormFieldControlTypeEnum.DecimalNumberTextBox.ToString().ToLower(),
                                                                                     DataType = "text"
                                                                                 },
                                                                             ...
                                                                             new MapRule()
                                                                                 {
                                                                                     ControlType = FormFieldControlTypeEnum.LongNumberTextBox.ToString().ToLower(),
                                                                                     DataType = "longtext"
                                                                                 },
                                                                             new MapRule()
                                                                                 {
                                                                                     ControlType = FormFieldControlTypeEnum.HtmlAreaControl.ToString().ToLower(),
                                                                                     DataType = "longtext"
                                                                                 }
                                                                         }
                                                                 },
                                                                     ...
                                                                     new List<MapRule>()
                                                                         {
                                                                             new MapRule()
                                                                                 {
                                                                                     ControlType = FormFieldControlTypeEnum.MediaSelectionControl.ToString().ToLower(),
                                                                                     DataType = "text"
                                                                                 },
